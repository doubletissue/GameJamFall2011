...
shelf_maps = [
              [
                ...
                [ 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ],
                [ 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ],
                [ 00, 00, 00, 31, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,00 ],
                [ 00, 00, 00, 32, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,00 ],
                [ 00, 00, 00, 33, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,00 ],
                [ 00, 00, 00, 34, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,00 ],
                [ 00, 00, 00, 31, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,00 ],
                [ 00, 00, 00, 31, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,00 ],
                [ 00, 00, 00, 31, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,00 ],
                [ 00, 00, 00, 31, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,00 ],
                ...
                [ 00, 00, 00, 31, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,00 ],
                [ 00, 00, 00, 31, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,00 ],
                [ 00, 00, 00, 31, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,50 ,00 ],  # 0 = down, 1 right, 2 up, 3 left
                [ 00, 00, 00, 31, 00, 00, 31, 00, 00, 31, 00, 00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,00 ,31 ,00 ,52 ,00 ],
                [ 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ],
                [ 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ],
                [ 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00, 00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ,00 ]
              ]
...
class Map:
  ...
  def __init__(self, level):
    ...
    for x in range(25):
      for y in range(25):
        if   self.shelves[x][y] == 32:
          self.items[ (x,y) ] = Item(0)
        elif self.shelves[x][y] == 33:
          self.items[ (x,y) ] = Item(1)
        elif self.shelves[x][y] == 34:
          self.items[ (x,y) ] = Item(2)
        
        if self.shelves[x][y] >= 50 and self.shelves[x][y] < 60:
          if   (x-1,y) in self.gate:
            self.gate[ (x,y) ] = Gate((x*40,y*40),self.gate[ (x-1,y) ].color, self.shelves[x][y]-50)
          elif (x+1,y) in self.gate:
            self.gate[ (x,y) ] = Gate((x*40,y*40),self.gate[ (x+1,y) ].color, self.shelves[x][y]-50)
          elif (x,y-1) in self.gate:
            self.gate[ (x,y) ] = Gate((x*40,y*40),self.gate[ (x,y-1) ].color, self.shelves[x][y]-50)
          elif (x,y+1) in self.gate:
            self.gate[ (x,y) ] = Gate((x*40,y*40),self.gate[ (x,y+1) ].color, self.shelves[x][y]-50)
          else:
            self.gate[ (x,y) ] = Gate((x*40,y*40),random.choice(range(0,12,2)), self.shelves[x][y]-50)
  ...
  def getShelfImage(self,x,y):
    if self.shelves[x][y] >= 30 and self.shelves[x][y] < 40:
